...
socket.on("rideRequestedData", (data) => {
  ...
  const requestDiv = `<div class="card" style="width: 100%"><div class="card-body"<h5 class="card-title"><strong>Ride Requested by ${data.name}</strong></h5><div> <p>Location: ${data.location}</p><p>Destination: ${data.destination}</p><p>Price: ${data.price}</p></div><div class="btn-group">
